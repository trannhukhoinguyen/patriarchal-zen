const CnLv0MasterDb = [
  {
    ...
    disciples: ['Jianzhi Sengcan', 'Tăng Na', 'Xiangzhou Huiman', 'Cư sĩ Lưu Hướng'],
  ...
  },
  {
    ...
    disciples: [],
    image: '',
    reference: ['https://ngulucthien.com/thien-su-tang-na/'],
  },
  {
    id: '30.3',
    name_en: 'Xiangzhou Huiman',
    name_ja: 'Xiangzhou Huiman',
    name_zh: 'Xiangzhou Huiman',
    ...
    teachers: ['Dazu Huike'],
    successors: [''],
    disciples: ['Hiện Sơn Thần Định', 'Bảo Nguyệt', 'Cư sĩ Hoa Nhàn', 'Đại sĩ Hóa Công', 'Hòa Công', 'Cư sĩ Liêu'],
    image: '',
    reference: [''],
  },
  {
    ...
    disciples: [],
    image: '',
    reference: ['https://ngulucthien.com/cu-si-huong/'],
  },
  {
    id: '31.1',
    name_en: 'Dayi Daoxin',
  ...
  },
  {
    ...
    successors: [''],
    disciples: ['Diên Lăng Huệ Giản', 'Bành Thành Huệ Sai', 'Dinglin Huigang'],
    image: '',
    reference: [''],
  },
  {
  ...
  },
  {
    ...
    other_name_vi: 'Tung Nhạc Huệ An',
    ...
    teachers: ['Daman Hongren'],
    successors: [''],
    disciples: ['Po Zao Dui', 'Đạo Lượng', 'Tung Nhạc Nguyên Khuê', 'Phúc Tiên Nhân Kiệm'],
    image: '/images/monocolor-unknown-zen-master.jpg',
    ...
    'https://pl.wikipedia.org/wiki/Lao%E2%80%99an_Hui%E2%80%99an',
      'https://ngulucthien.com/dong-tung-nhac-hue-an/', 'https://ngulucthien.com/thien-su-hue-an/'
    ],
  },
  {
    id: '33.5',
  ...
  },
  {
    ...
    name_ja: 'Dinglin Huigang',
    name_zh: '定林慧綱',
    name_vi: 'Định Lâm Tuệ Cương',
    other_name_vi: 'Định Lâm Huệ Cương',
    birth_death_time: ['', ''],
    epoch: '',
    records: '',
    sect: [],
