  ...
  },
{
  ...
  },
  {
    ...
    country: '🇮🇳',
    place: '-',
    teachers: ['Haklenayaśas'],
    successors: ['Basiasita'],
    disciples: ['Basiasita', 'Dharmadha',],
    image: '/images/avatar.png',
    reference: ['',],
  },
  {
  ...
  },
  {
    ...
    disciples: ['Dazu Huike', 'Ni Zong Chi (Ni Tổng Trì)'],
    other_disciples: ['6 Tôn giả đứng đầu 6 tông Hữu tướng, Vô tướng, Định tuệ, Giới hạnh, Vô đắc, Tịch tỉnh', 'Đạo Dục', 'Đạo Phó'],
