...
cardImageAlt: "Thiền sư Mục Châu Đạo Minh"
...
<div className="grid xl:grid-cols-8 lg:grid-cols-8 md:grid-cols-2 sm:grid-cols-2 xs:grid-cols-1 gap-8 bg-body dark:bg-darkmode-body">
  ...
  <div className="lg:col-span-3 md:col-span-1">
    ...
    <img decoding="async" src="/images/masters/monocolor-unknown-zen-master.jpg" alt="Thiền sư Mục Châu Đạo Minh (Trần Tôn Túc) - Tổ Sư Thiền - Patriarchal Zen" />
