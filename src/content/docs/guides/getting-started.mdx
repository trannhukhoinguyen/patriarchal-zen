...
<CardGrid>
  <Card title="Ensemble de tournevis" icon="seti:config">
    ...
    <LinkCard title="En savoir plus " href="vi/guides/getting-started" />
  </Card>
...
1. Icône de déballage Déballez vos outils Patriarchal Zen
