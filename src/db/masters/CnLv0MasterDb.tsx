const CnLv0MasterDb = [
  ...
  },
  {
    ...
    successors: [''],
    disciples: ['Diên Lăng Huệ Giản', 'Bành Thành Huệ Sai', 'Định Lâm Tuệ Cương'],
    image: '',
    reference: [''],
  },
  {
  ...
  },
  {
    ...
    teachers: ['Daman Hongren'],
    successors: [''],
    disciples: ['Po Zao Dui (Tung Nhạc Phá Táo Đọa)', 'Đạo Lượng', 'Tung Nhạc Nguyên Khuê', 'Phúc Tiên Nhân Kiệm'],
    image: '/images/monocolor-unknown-zen-master.jpg',
